      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 d-none d-lg-block">
            ...
            <a href="library/adminlogin.php">Admin  | </a>
            <a href="library/index.php"> User Dashboard</a>
          </div>
        ...
        <div class="d-flex align-items-center">
          <div class="site-logo">
            <a href="index.php" class="d-block">
              <img src="images/elogo-02.png" alt="Image" class="img-fluid">
            </a>
          </div>
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                  <a href="books.php" class="nav-link text-left">Books</a>
                </li>
                <li>
                  <a href="subscription.php" class="nav-link text-left">Subscription</a>
                </li>
                <li>
