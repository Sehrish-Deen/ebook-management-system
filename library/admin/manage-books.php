                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
                                        $sql = "SELECT tblbooks.BookName, tblcategory.CategoryName, tblauthors.AuthorName, tblbooks.ISBNNumber, tblbooks.BookPrice, tblbooks.cover_img, tblbooks.book_pdf, subscription.charges, tblbooks.id as bookid
                                                FROM tblbooks 
                                        ...
                                        if($query->rowCount() > 0) {
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <img src="uploads/books/<?php echo htmlentities($result->cover_img);?>" alt="Cover Image" width="50">
                                                    <?php else: ?>
                                                    No Image
                                                    <?php endif; ?>
                                                </td>
                                                <td class="center">
                                                    <?php if($result->book_pdf): ?>
                                                    <a href="uploads/books/<?php echo htmlentities($result->book_pdf);?>" target="_blank">View PDF</a>
                                                    <?php else: ?>
                                                    No PDF
                                                    <?php endif; ?>
                                                </td>
