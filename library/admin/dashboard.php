...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Ebook Management System | Admin Dash Board</title>
...
?>
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-6">
                      ...
                      <i class="fa fa-envelope fa-5x"></i>
                            <?php 
$sql7 ="SELECT id from message ";
$query7 = $dbh -> prepare($sql7);
$query7->execute();
$results4=$query7->fetchAll(PDO::FETCH_OBJ);
$mess=$query7->rowCount();
?>
                            <h3><?php echo htmlentities($mess);?></h3>
                            Users Message
                        </div>
                    </div>
