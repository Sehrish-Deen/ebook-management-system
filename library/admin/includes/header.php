<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Subscription <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-subscription.php">Add Subscription</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-subscriptions.php">Manage Subscription</a></li>
                                </ul>
                            </li>


                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Competition <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="comp.php">Add Competition</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-competitions.php">Manage Competition</a></li>
                                </ul>
                            </li>
  ...
  <li><a href="submission-details.php">Submissions</a></li>
